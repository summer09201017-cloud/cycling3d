...
const CACHE_NAME = "cycling3d-nf9"; // nf6:idle 生動抽成 3d-figure-kit 共用資產 idle-life.js(行為不變);nf5 騎士往左看+微笑放大(0.6rad/1.4)+觀眾舉手歡呼+左右看+耳前無髮鐵律;nf4 騎士 idle 生動(headGroup 群組化);nf3 安全帽開關+車身加高;nf1 首發(fork speedskating3d)
